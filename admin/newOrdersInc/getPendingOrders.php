<?php
session_start();
    if(isset($_SESSION['bookshelfAdminID']) && isset($_POST['pendingOrdersBtn'])){
        include "../../connection.php";
        $query="Select orders.orderID,orderDate,orderedBy,paymentStatus,qty,bookName,price from orders,orderdetails,books,paymentdetails where orders.orderStatus = 'Out for Delivery' and orders.orderID=orderdetails.orderID and orderdetails.product=books.bookID and orders.orderID=paymentdetails.orderId ";
        ...
        if(mysqli_num_rows($res)>0){
            ...
            ?>
             <tr>
                ...
                <td>
                    <button class="btn btn-success accept btn-sm mr-2" onclick="deliver('<?php echo $rowOrders['orderID'] ?>')"> <i class="fa fa-check fa-lg m-1"></i> </button>
