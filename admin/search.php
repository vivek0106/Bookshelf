    ...
    <div class="containe-fluid">
        ...
        <div class="col-sm-7 offset-sm-1 bookList">
            ...
            include 'connection.php';
                ...
                $url = "http://localhost/BookShelf/admin/search.php?searchBook=".$_GET['searchBook'];
                $results_per_page = 10;             
                ...
                if($count==0){
                    echo "<h4 class='mt-4 font-weight-bold'>No results found for input - <span class='text-primary' style='font-size:1.3rem;text-decoration:underline; font-weight:500'>$search </span></h4>";
                }
                else{
                    echo "<h5 class='mt-4 font-weight-bold'>Showing results for - <span class='text-primary' style='font-size:1.3rem;text-decoration:underline; font-weight:500'>$search </span></h5>";
                    if (isset ($_GET['page'])) {  
                        $page = $_GET['page'];  
                    }
            ...
            <div class="col-sm-3" id="bookDetails"> 
